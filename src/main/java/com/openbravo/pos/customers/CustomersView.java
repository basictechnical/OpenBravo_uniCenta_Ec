...
import expert.allku.validar.Validar;
...
public final class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    /**
     * Valida que no haya vacío
     *
     * @param campo campo de texto a validar
     * @param evt evento de pierde foco FocusLost
     */
    ...
    /**
     * Valida el RUC y la Cédula
     *
     * @param campo campo de texto, es el RUC o Cédula a validar
     * @param evt evento de pierde foco FocusLost
     */
...
// JG 3 Oct 2013 - for Transaction List table
    ...
    public Object createValue() throws BasicException {
        ...
        if (!validar.validaVacio(m_jTaxID.getText())) {
            throw new BasicException("Por favor ingrese la CI / RUC / Pasaporte / Consumidor Final");
        }        
        if (!validar.validaVacio(m_jName.getText())) {
            throw new BasicException("Por favor ingrese la razón social");
        }        
        if (!validar.validaDocumento(m_jTaxID.getText(), ComboDocumento.getSelectedItem().toString())) {
            throw new BasicException(ComboDocumento.getSelectedItem().toString() + " : " + m_jTaxID.getText() + " no es correcto");
        }
...
//            CustomerTransaction customerTransaction = transactionList.get(row);
    ...
    private void initComponents() {
        ...
        m_jSearchkey.setFocusable(false);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addComponent(m_jVip, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(m_jSearchkey, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)))))
